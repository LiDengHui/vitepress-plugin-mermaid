...
type RequiredMarkdownOptions = Required<MarkdownOptions>;
type MarkdownItAsync = Parameters<RequiredMarkdownOptions["config"]>[0];

interface MermaidMarkdownOptions {
    class?: string;
}

export const MermaidMarkdown = (md: MarkdownItAsync, pluginOptions?: MermaidMarkdownOptions) => {
